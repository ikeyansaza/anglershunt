...
<br>
      <div class="register-items">
        パスワード<span class="register-span">（８文字以上）</span> <br><br><input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
